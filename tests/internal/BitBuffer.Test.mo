...
suite("BitBuffer.addBit / getBit", func() {

  test("single true bit", func() {
  ...
  test("8 bits fill one byte, all positions correct", func() {
    let b = BitBuffer.BitBuffer(8);
...
suite("BitBuffer.addBits / getBits", func() {

  test("addBits(3, 5) then getBits(0, 3) = 5", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(3, 5);
  ...
  test("addBits(8, 0xAB) = full byte", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(8, 0xAB);
    expect.nat(b.getBits(0, 8)).equal(0xAB);
  });

  test("addBits(0, x) is no-op", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(0, 99);
    expect.nat(b.bitSize()).equal(0);
  });

  test("two consecutive addBits, read each section back", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("addBits across byte boundary, read back full 16 bits", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(16, 0xCAFE);
    expect.nat(b.getBits(0, 16)).equal(0xCAFE);
  });

  test("LSB-first: addBits(3, 6) => bit0=0, bit1=1, bit2=1", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("unaligned addBits fills remaining byte bits exactly", func() {
    let b = BitBuffer.BitBuffer(8);
...
suite("BitBuffer.addByte / getByte", func() {

  test("addByte then getByte at offset 0", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0x42);
    expect.nat8(b.getByte(0)).equal(0x42);
  });

  test("two bytes, read both at correct bit offsets", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xDE);
    b.addByte(0xAD);
  ...
  test("getByte on unaligned bit position", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(3, 0);
    b.addByte(0x7F);
  ...
  test("getByte zero-pads when fewer than 8 bits remain", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(4, 15); // 0xF
    expect.nat8(b.getByte(0)).equal(0x0F);
  });

  test("getByte beyond buffer returns 0", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xFF);
...
suite("BitBuffer.addBytes / getBytes", func() {

  test("addBytes round-trip", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("getBytes at non-zero startBit", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("addBytes after a full aligned byte", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(8, 0);
...
suite("BitBuffer.byteAlign", func() {

  test("already aligned is no-op", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xFF);
    b.byteAlign();
    expect.nat(b.bitSize()).equal(8);
  ...
  test("pads partial byte to 8 bits", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(3, 5);
    b.byteAlign();
    expect.nat(b.bitSize()).equal(8);
  ...
  test("existing data preserved after byteAlign", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(3, 5);
    b.byteAlign();
    expect.nat(b.getBits(0, 3)).equal(5);
  ...
  test("byteAlign then addByte produces correct layout", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(3, 7);
    b.byteAlign();
    b.addByte(0xAB);
  ...
  test("empty buffer byteAlign is no-op", func() {
    let b = BitBuffer.BitBuffer(8);
    b.byteAlign();
    expect.nat(b.bitSize()).equal(0);
  });
...
suite("BitBuffer.dropBits", func() {

  test("drop 3 bits, remaining bits shift to position 0", func() {
  ...
  test("drop a full byte, next byte accessible at position 0", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xDE);
    b.addByte(0xAD);
    b.dropBits(8);
  ...
  test("drop all bits leaves bitSize = 0", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("drop zero bits is no-op", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xAA);
    b.dropBits(0);
    expect.nat(b.bitSize()).equal(8);
  ...
  test("drop then add more bits", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xFF);
    b.dropBits(8);
    b.addByte(0x42);
...
suite("BitBuffer.clear", func() {

  test("clear resets bitSize to 0", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("can write and read after clear", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("clear resets dropBits offset too", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(16, 0xABCD);
    b.dropBits(8);
    b.clear();
...
suite("BitBuffer.bytes", func() {

  test("bytes() over 3 bytes", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("bytes() on empty buffer yields nothing", func() {
    let b = BitBuffer.BitBuffer(8);
    let result = Iter.toArray(b.bytes());
    expect.array(result, Nat8.toText, Nat8.equal).equal([]);
  });

  test("bytes() after byteAlign includes padding byte", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("bytes() after dropBits(8) skips first byte", func() {
    let b = BitBuffer.BitBuffer(8);
...
suite("BitBuffer capacity growth", func() {

  test("writing 64 bytes triggers multiple capacity doublings", func() {
  ...
  test("BitBuffer.new() works like BitBuffer(0)", func() {
    let b = BitBuffer.new();
    b.addBits(4, 15);
...
suite("BitBuffer unaligned multi-byte writes", func() {

  test("addBits(3, 7) then addBits(13, 0x1ABC) round-trips", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(3, 7);
    b.addBits(13, 0x1ABC);
    expect.nat(b.bitSize()).equal(16);
  ...
  test("addBits at offset 5 spanning 3 bytes", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("high bits of value above n are ignored", func() {
    let b = BitBuffer.BitBuffer(8);
...
suite("BitBuffer unaligned multi-byte reads", func() {

  test("getBits across 3 byte boundaries from unaligned start", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("getBits at offset 7 spanning byte boundary (1 + 8 + 1 = 10 bits)", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("getBits(i, 0) returns 0", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xFF);
    expect.nat(b.getBits(3, 0)).equal(0);
  });

  test("getBytes(_, 0) returns empty array", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addByte(0xAB);
...
suite("BitBuffer interleaved sequences", func() {

  test("dropBits to partial-byte position, then multi-byte read", func() {
    let b = BitBuffer.BitBuffer(8);
  ...
  test("write, drop partial, write more, read both segments", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(11, 0x5A5);
    b.dropBits(3);
    b.addBits(5, 21);
  ...
  test("streaming decoder pattern: read header, drop, read payload", func() {
    let b = BitBuffer.BitBuffer(8);
...
suite("BitBuffer round-trip property", func() {

  test("addBits/getBits round-trip across (n, v) grid", func() {
    let cases : [(Nat, Nat)] = [
      (1, 0), (1, 1),
      (3, 5), (3, 7),
      (5, 21), (5, 31),
...
suite("BitBuffer.bytes alignment guard", func() {

  test("bytes() and getBytes(0, byteSize) agree when aligned", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBytes([0xDE, 0xAD, 0xBE, 0xEF]);
  ...
  test("bytes() after byte-aligned dropBits(16)", func() {
    let b = BitBuffer.BitBuffer(8);
...
suite("BitBuffer.clear edge cases", func() {

  test("clear after partial dropBits + addBits resets cleanly", func() {
    let b = BitBuffer.BitBuffer(8);
    b.addBits(11, 0x7FF);
    b.dropBits(3);
    b.addBits(5, 17);
  ...
  test("clear after capacity growth still allows writes", func() {
    let b = BitBuffer.BitBuffer(8);
